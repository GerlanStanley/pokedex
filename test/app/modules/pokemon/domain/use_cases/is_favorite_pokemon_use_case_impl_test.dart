...
import 'package:pokedex/app/modules/pokemon/domain/use_cases/is_favorite_pokemon_use_case_impl.dart';

class MockPokemonRepository extends Mock implements PokemonRepository {}

void main() {
  late MockPokemonRepository repository;
  late IsFavoritePokemonUseCaseImpl useCase;
  late PokemonEntity pokemon;

  setUp(() {
    repository = MockPokemonRepository();
    useCase = IsFavoritePokemonUseCaseImpl(repository);
  ...
  test(
    ...
    () async {
      when(
        () => repository.isFavorite(pokemon: any(named: "pokemon")),
