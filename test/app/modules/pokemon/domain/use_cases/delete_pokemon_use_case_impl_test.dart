...
import 'package:pokedex/app/modules/pokemon/domain/use_cases/delete_pokemon_use_case_impl.dart';

class MockPokemonRepository extends Mock implements PokemonRepository {}

void main() {
  late MockPokemonRepository repository;
  late DeletePokemonUseCaseImpl useCase;
  late PokemonEntity pokemon;

  setUp(() {
    repository = MockPokemonRepository();
    useCase = DeletePokemonUseCaseImpl(repository);
  ...
  test(
    ...
    () async {
      when(
        () => repository.delete(pokemon: any(named: "pokemon")),
